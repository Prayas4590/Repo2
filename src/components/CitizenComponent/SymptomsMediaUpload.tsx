...
export type MediaFile = { name: string; size: number; type: string };
...
export default function SymptomsMediaUpload({ files, onChange }: Props) {
  ...
  return (
    <Card className="material-card">
      <CardHeader className="pb-2">
        <CardTitle className="title-medium">Photos / Videos (Optional)</CardTitle>
      </CardHeader>
