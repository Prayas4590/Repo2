...
import type { Contact } from './DoctorChatContactsCard';

type Props = { contact: Contact; onBack: () => void };
...
export default function DoctorChatInterface({ contact, onBack }: Props) {
  ...
  const [messages, setMessages] = useState<any[]>([
    ...
    { id: 2, sender: 'You', message: 'I would like to discuss a case.', time: '10:31 AM', isOwn: true },
  ]);
