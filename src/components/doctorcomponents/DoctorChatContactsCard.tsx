...
const contacts: Contact[] = [
  { id: 'd1', name: 'Community ASHA - Sunita Devi', role: 'ASHA Worker', phone: '+911234567890', online: true, type: 'individual' },
  { id: 'd2', name: 'PHC - Rampur', role: 'PHC', phone: '+911801234567', online: false, type: 'group' },
  { id: 'd3', name: 'Dr. Priya Sharma', role: 'Doctor', phone: '+911112223334', online: true, type: 'individual' },
];

const getInitials = (name: string) => name.split(' ').map(n => n[0]).join('').toUpperCase();

type Props = { onChat?: (contact: Contact) => void };
